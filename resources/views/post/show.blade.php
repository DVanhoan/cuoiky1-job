                        ...
                        <div class="company-info">
                            <div class="company-banner">
                                ...
                                @if ($company->cover_img == 'nocover')
                                    <img
                                        src="{{ asset('images/companies/nocover.jpg') }}"
                                        class="company-banner-img img-fluid"
                                        alt=""
                                    />
                                @else
                                    <img
                                ...
                                <div class="company-media">
                                    ...
                                    <div>
                                        <a
                                            href="{{ route('account.employer', ['id' => $company->id]) }}"
                        ...
                        <div class="job-info">
                            ...
                            <div class="job-bdy p-3 my-3">
                                ...
                                <div class="d-flex justify-content-between">
                                    <div>
                                        <a
                                            href="{{ route('account.applyJobView', ['post_id' => $post]) }}"
                                            class="btn primary-btn"
                                        >
                                            Apply now
                                        </a>
                                        <a
                                            href="{{ route('savedJob.store', ['id' => $post]) }}"
                    ...
                    <div class="card d-none d-md-block mb-3">
                        ...
                        <div class="card-body">
                            <div class="btn-group w-100">
                                <a
                                    href="{{ route('account.applyJobView', ['post_id' => $post->id]) }}"
                                    class="btn primary-outline-btn float-left"
                                >
                                    Apply Now
                                </a>
                                <a
                                    href="{{ route('savedJob.store', ['id' => $post->id]) }}"
                                    class="btn primary-btn"
                                >
                                    <i class="fas fa-star"></i>
                                    Save job
                                        ...
                                        <div class="job-item border-bottom row">
                                            ...
                                            <div class="job-desc col-8">
                                                ...
                                                >
                                                    ...
                                                    <p
                                                        class="font-weight-normal small text-danger"
                                                    >
                                                        Deadline:
                                                        {{ date('d', $job->remainingDays()) }}
                                                        days
                                                    </p>
                                                </a>
                                            </div>
