                                    ...
                                    <div class="card-body p-0">
                                        ...
                                        >
                                            ...
                                            >
                                                ...
                                                <option
                                                    value="Senior level"
                                                    {{ request('job_level') == 'Senior level' ? 'selected' : '' }}
                                                >
                                                    Senior level
                                                </option>
                                                <option
                                                    value="Mid level"
                                                    {{ request('job_level') == 'Mid level' ? 'selected' : '' }}
                                                >
                                                    Mid level
                                                </option>
                                                <option
                                                    value="Top level"
                                                    {{ request('job_level') == 'Top level' ? 'selected' : '' }}
                                                >
                                                    Top level
                                                </option>
                                                <option
                                                    value="Entry level"
                                                    {{ request('job_level') == 'Entry level' ? 'selected' : '' }}
                                                >
                                                    Entry level
                                                </option>
                                            </select>
                                    ...
                                    <div class="card-body p-0">
                                        ...
                                        >
                                            ...
                                            >
                                                ...
                                                <option
                                                    value="Bachelors"
                                                    {{ request('education_level') == 'Bachelors' ? 'selected' : '' }}
                                                >
                                                    Bachelors
                                                </option>
                                                <option
                                                    value="High School"
                                                    {{ request('education_level') == 'High School' ? 'selected' : '' }}
                                                >
                                                    High School
                                                </option>
                                                <option
                                                    value="Master"
                                                    {{ request('education_level') == 'Master' ? 'selected' : '' }}
                                                >
                                                    Master
                                                </option>
                                                <option
                                                    value="SEE Mid School"
                                                    {{ request('education_level') == 'SEE Mid School' ? 'selected' : '' }}
                                                >
                                                    SEE Mid School
                                                </option>
                                                <option
                                                    value="Other"
                                                    {{ request('education_level') == 'Other' ? 'selected' : '' }}
                                                >
                                                    Other
                                                </option>
                                            </select>
                                    ...
                                    <div class="card-body p-0">
                                        ...
                                        >
                                            ...
                                            >
                                                ...
                                                <option
                                                    value="Trainneship"
                                                    {{ request('employment_type') == 'Trainneship' ? 'selected' : '' }}
                                                >
                                                    Trainneship
                                                </option>
                                                <option
                                                    value="Volunteer"
                                                    {{ request('employment_type') == 'Volunteer' ? 'selected' : '' }}
                                                >
                                                    Volunteer
                                                </option>
                                            </select>
                                        ...
                                        >
                                            ...
                                            >
                                                ...
                                                @foreach ($provinces as $location)
                                                    <option
                                                        value="{{ $location->name }}"
                                                        {{ request('job_location') == $location->name ? 'selected' : '' }}
                                                    >
                                                        {{ $location->name }}
                                                    </option>
                                                @endforeach
                                ...
                                <div class="card mt-3 hover-shadow">
                                    <div class="card-body">
                                        ...
                                        <div class="row align-items-center text-center text-lg-left">
                                            ...
                                            >
                                                <h5
                                                    class="secondary-link font-weight-bold"
                                                >
                                                    <a
